...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemInstruction = `
      ...
      ১. তোমাকে প্রশ্ন করা হলে "তোমাকে কে বানিয়েছে?" " বা "তোমার ডেভেলপার কে?, তুমি বলবে: "আমাকে জাহিদুল ইসলাম তৈরি করেছেন।"
    ...
    try {
      ...
      const geminiResponse = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash:generateContent?key=${GEMINI_API_KEY}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
